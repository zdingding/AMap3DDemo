...
public class SmoothMoveActivity extends Activity {
    ...
    private void init() {
        ...
        if (mAMap == null) {
         ...
         myOnMapTouchListener =new MyOnMapTouchListener(SmoothMoveActivity.this,mAMap,true);
        mAMap.setOnMapTouchListener(myOnMapTouchListener);
    ...
    public void startMove(View view) {
        ...
        // 读取轨迹点
        List<LatLng> points = myOnMapTouchListener.getLatLngs();//所有的点 与我的位置
        // 构建 轨迹的显示区域
    ...
    private void addPolylineInPlayGround() {
      //  List<LatLng> list = readLatLngs();
        List<LatLng> list = myOnMapTouchListener.getLatLngs();//所有的点 与我的位置
...
//				.setCustomTextureIndex(texIndexList)
        ...
        mAMap.animateCamera(CameraUpdateFactory.newLatLngBounds(bounds, 80));
    }
